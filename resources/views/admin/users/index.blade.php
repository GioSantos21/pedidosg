                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sucursal Asignada</th>
                                    <th class="px-6 py-3 bg-gray-50 text-right">Acciones</th>
                                </tr>
                            </thead>
